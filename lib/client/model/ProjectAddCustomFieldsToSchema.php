...
/**
 * ProjectAddCustomFieldsToSchema Class Doc Comment
 *
 * @category    Class */
/** 
 * @package     Rakam
 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class ProjectAddCustomFieldsToSchema implements ArrayAccess
{
    /**
      * The original name of the model.
      * @var string
      */
    protected static $swaggerModelName = 'ProjectAddCustomFieldsToSchema';
    ...
    public function listInvalidProperties()
    {
        ...
        $allowed_values = array("AVRO");
        if (!in_array($this->container['schema_type'], $allowed_values)) {
            $invalid_properties[] = "invalid value for 'schema_type', must be one of #{allowed_values}.";
        }
    ...
    {
        $allowed_values = array('AVRO');
        if (!in_array($schema_type, $allowed_values)) {
            throw new \InvalidArgumentException("Invalid value for 'schema_type', must be one of 'AVRO'");
        }
