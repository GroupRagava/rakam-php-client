...
/**
 * ProjectCheckApiKeys Class Doc Comment
 *
 * @category    Class */
/** 
 * @package     Rakam
 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class ProjectCheckApiKeys implements ArrayAccess
{
    /**
      * The original name of the model.
      * @var string
      */
    protected static $swaggerModelName = 'ProjectCheckApiKeys';
    ...
    protected static $swaggerTypes = array(
        'keys' => '\client.model\ProjectApiKeys[]',
        'project' => 'string'
    );
    ...
    /**
     * Sets keys
     * @param \client.model\ProjectApiKeys[] $keys
     * @return $this
     */
