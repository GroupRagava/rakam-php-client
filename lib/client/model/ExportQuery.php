 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class ExportQuery implements ArrayAccess
{
    /**
      * The original name of the model.
      * @var string
      */
    protected static $swaggerModelName = 'ExportQuery';
    ...
    /**
     * Sets query
     * @param string $query SQL query that will be executed on data-set
     * @return $this
     */
