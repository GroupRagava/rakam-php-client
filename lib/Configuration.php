...
class Configuration
{
     ...
     * @var string
     */
    protected $host = 'https://app.rakam.io/';
     ...
     * @var string
     */
    protected $userAgent = "Swagger-Codegen/0.5/php";
    ...
    {
        $report  = 'PHP SDK (Rakam) Debug Report:' . PHP_EOL;
        $report .= '    OS: ' . php_uname() . PHP_EOL;
        $report .= '    PHP Version: ' . phpversion() . PHP_EOL;
        $report .= '    OpenAPI Spec Version: 0.5' . PHP_EOL;
        $report .= '    SDK Package Version: 0.5' . PHP_EOL;
